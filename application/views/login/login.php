        ...
        <div class="row justify-content-center">
          <div class="col-md-7 col-lg-5">
            <div class="login-wrap p-4 p-md-5">
              ...
              <p class="text-center">LOGIN APP <br> <label class="text-success" style="font-weight: bold;">KELUH KESAH MASYRAKAT LANGKAT</label></p>
              <form method="post" action="<?= base_url('login/act_login') ?>">
                ...
                <div class="form-group">
                  <button type="submit" class="form-control btn btn-primary rounded submit px-3">Login APP</button>
                </div>
